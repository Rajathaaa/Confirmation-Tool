...
const OtherAssetsSecurityDepositsForm = ({ confirmation }: { confirmation: any }) => {
  const [rows, setRows] = useState([{ amountDue: "", currency: "", rateOfInterest: "", interestAccrued: "", collateral: "", terms: "" }]);

  const addRow = () => setRows([...rows, { amountDue: "", currency: "", rateOfInterest: "", interestAccrued: "", collateral: "", terms: "" }]);
  ...
  return (
    ...
    >
      <p className="text-sm text-muted-foreground mb-4">
        Kindly confirm to us the following information in respect of amounts receivable from you in respect of Inter Corporate Deposits / Loans / Advances as on {confirmation.periodEndDate}.
      </p>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Collateral if any</TableHead>
              <TableHead>Terms of Repayment</TableHead>
...
export default OtherAssetsSecurityDepositsForm;
