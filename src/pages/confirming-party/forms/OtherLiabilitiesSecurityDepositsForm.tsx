...
const OtherLiabilitiesSecurityDepositsForm = ({ confirmation }: { confirmation: any }) => {
  ...
  const addRow = () => setRows([...rows, { amountDue: "", amountOverdue: "", currency: "", rateOfInterest: "", interestAccrued: "", collateral: "", terms: "" }]);
    ...
    <BaseConfirmationForm
      ...
      getFormData={() => ({ 
        tableRows: rows.map(row => ({
          ...
          "Amount Overdue if any": row.amountOverdue,
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Amount Overdue if any</TableHead>
...
export default OtherLiabilitiesSecurityDepositsForm;